  ...
  return (
    <section className="bg-white text-primary min-h-80 shadow-lg rounded-md shadow-primary px-0 overflow-hidden grid lg:grid-cols-2 items-center">
      ...
      <article className="text-lg space-y-5 py-5 lg:py-10 px-5 lg:px-10">
        ...
        <p>
          Здравейте! Аз съм Кристиан, уеб програмист и WordPress разработчик на
          свободна практика, фокусиран върху изграждането на ефективни,
          иновативни и персонализирани уеб решения. Работя с както с WordPress,
          така правя и custum сайтове с Next.js, React и TypeScript, за да
          създавам бързи, сигурни и добре оптимизирани приложения, без
          ограниченията на готовите CMS системи.
        </p>
        <p>
          ...
          по-голяма гъвкавост спрямо други стандартни темплейтни сайтове. Роботя
          както с готови WordPress теми, така и с изцяло персонализирани
          решения, които осигуряват по-добра скорост, сигурност и лесно
