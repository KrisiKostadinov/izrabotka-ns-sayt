      ...
      <article className="py-10 container mx-auto grid lg:grid-cols-2 gap-10 justify-between items-center">
        ...
        <div className="space-y-5 max-md:text-center">
          ...
          <p className="text-lg max-w-4xl mx-auto">
            Предлагам гъвкави уеб решения, съчетавайки модерни технологии като
            Next.js, React и TypeScript, както и доказани платформи като
            WordPress и WooCommerce. Работя спрямо спецификите на всеки проект –
            от персонализирана разработка до ефективно използване на готови CMS
            системи – с фокус върху бързина, сигурност и SEO оптимизация.
          </p>
          ...
          <ul className="flex flex-col gap-2 list-disc pl-10 text-left">
            ...
            <li>
              <p>
                ...
                <span> – интерактивни, динамични и напълно функционални</span>
              </p>
            </li>
          </ul>
          <p className="text-lg">
